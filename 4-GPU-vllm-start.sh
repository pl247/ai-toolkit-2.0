...
echo -e "\n\n\n"
python -m vllm.entrypoints.openai.api_server --model /ai/models/NousResearch/Meta-Llama-3-8B-Instruct/ --api-key LLM --host $ip --port 8000 --tensor-parallel-size 4 --dtype=half 
